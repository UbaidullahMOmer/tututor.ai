...
function SmallCard() {
  return (
    <div style={{ boxShadow: "0px 4px 40px 0px rgba(0, 0, 0, 0.05)" }} class="bg-white border border-[#F5F5F5] flex  gap-[14px] rounded-[20px] p-[12px] shadow-[0_4px_40px_-15px_rgba(0,0,0,0.05)]">
